...
public class MainActivity extends AppCompatActivity {
    private static final String CHANNEL_ID = "ru.mirea.zhumanov.notification.ANDROID";
    ...
    public void onClickNewMessageNotification(View view) {
        ...
        NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Жуманов Тимур Аскарович", importance);
